...
public abstract class Type {
    ...
    public static final Type INT16 = new Type() {
        ...
        public Short validate(Object item) {
            if (item instanceof Short) {
                ...
                throw new RuntimeException(item + " is not a Short.");
            }
        }
    };
    ...
    public static final Type INT64 = new Type() {
        ...
        public Long validate(Object item) {
            if (item instanceof Long) {
                ...
                throw new RuntimeException(item + " is not a Long.");
            }
        }
    };
    ...
    public static final Type STRING = new Type() {
        ...
        public void write(ByteBuffer buffer, Object o) {
            ...
            if (bytes.length > Short.MAX_VALUE) {
                throw new RuntimeException("String length " + bytes.length + " is larger than the maximum string length.");
            }
        ...
        public Object read(ByteBuffer buffer) {
            ...
            if (length < 0) {
                throw new RuntimeException("String length " + length + " cannot be negative");
            }
            if (length > buffer.remaining()) {
                throw new RuntimeException("Error reading string of length " + length + ", only " + buffer.remaining() + " bytes available");
            }
    ...
    public static final Type BYTES = new Type() {
        ...
        public Object read(ByteBuffer buffer) {
            ...
            if (size < 0) {
                throw new RuntimeException("Bytes size " + size + " cannot be negative");
            }
            if (size > buffer.remaining()) {
                throw new RuntimeException("Error reading bytes of size " + size + ", only " + buffer.remaining() + " bytes available");
            }
        ...
        public ByteBuffer validate(Object item) {
            if (item instanceof ByteBuffer) {
                ...
                throw new RuntimeException(item + " is not a java.nio.ByteBuffer.");
            }
        }
    };
