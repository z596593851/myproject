    ...
    public Schema(Field... fs) {
        ...
        for (int i = 0; i < this.fields.length; i++) {
            ...
            if (fieldsByName.containsKey(field.name)) {
                throw new RuntimeException("Schema contains a duplicate field: " + field.name);
            }
    ...
    public void write(ByteBuffer buffer, Object o) {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            try {
                ...
                throw new RuntimeException("Error writing field '" + f.name +
                                          "': " +
        ...
        try {
            ...
            for (int i = 0; i < this.fields.length; i++) {
                ...
                try {
                    ...
                    throw new RuntimeException("Invalid value for field '" + field.name + "': " + e.getMessage());
                }
            }
            return struct;
